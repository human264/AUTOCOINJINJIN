package com.backgom.coco.service
...
import com.backgom.coco.dataModel.CurrentPrice
import com.backgom.coco.dataModel.CurrentPriceResult
...
class PriceForegroundService : Service() {
    ...
    private suspend fun getAllCoinList(): ArrayList<CurrentPriceResult> {
